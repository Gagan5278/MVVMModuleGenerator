...
//  
//
//  Created by Gagan  Vishal on 11/16/20.
//

import Foundation
let templateName = "MVVMModule.xctemplate"
...
func moveTemplate(){
    ...
    do {
        if !fileManager.fileExists(atPath:"\(destinationPath)/\(templateName)"){
            ...
            printInConsole("✅  MVVM Template installed succesfully 🎉. Enjoy it 🙂")
        ...
        printInConsole("❌  Ooops! Something went wrong in installation😡 : \(error.localizedFailureReason!)")
    }
}
